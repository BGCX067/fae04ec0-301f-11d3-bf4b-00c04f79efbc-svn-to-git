...
Renderer.prototype = {
    init: function(){
		...
		me.container.append("<div id='"+ me.setting.bottomLogoID + "'/>");
    ...
    me.track(data, "Microsoft Volume Licensing - Office 2013");
    }
    /**
    ...
    ,buildUtil: function(){
        ...
        div.append(print);
        div.append(email);
		//load print logo before print event click.
    ...
    ,setupPrinting: function(data){
        var me = this;
		$("div#widget-print").remove();
		var printLogo = $("<img src='../../global/licensing/RenderingAssets/Office2013/images/print-logo.png'/>");
        $("div#widget-print").remove();

        var print = $("<div id='widget-print' />").appendTo(me.container);
        print.append(printLogo);

        var breadcrumb = me.getbreadcrumb(data);
        print.append("<div id='breadcrumb'>Source: <a href='Office-2.html'>http://www.microsoft.com/licensing/about-licensing/Office.aspx</a><br /><span class='crumb'>" + breadcrumb + "</span></div>");
    ...
    ,genEmail: function(){
        var me = this;
        var body = "";
        body += encodeURIComponent("Microsoft Office 2013 Volume Licensing Buyer's Guide");
        body += "%0D%0A";
        body += encodeURIComponent("Return to Buyer's Guide: http://www.microsoft.com/licensing/about-licensing/Office.aspx");
        body += "%0D%0A";
        body += "%0D%0A";
        ...
        return "mailto:" + "?subject=" + encodeURIComponent("Answer from Microsoft Office 2013 Buyer's Guide") + "&body=" + body;
    }
    /**
