...
Renderer.prototype = {
    ...
    ,click: function(e){
        ...
        me.track(data, "Microsoft Volume Licensing - Windows 8");
    }
    /**
    ...
    ,createInstruction: function(){
        ...
        div.append("<div id='instr-title'>How can we help you?</div>")
            ...
            .append("<a id='back'>Back</a>")
            .append("<a id='restart'>Return to Start</a>");
    ...
    ,updateTitle: function(title, caption) {
        ...
        var defaultHeightTitle = 40, // Hardcode
    ...
    ,loadNav: function(data, history){
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            var a = btn.find("a");
            //console.log(a.height() + "-" +a.parent().height());
            var height = a.height() + 40;
            if(height > 45) maxHeight = height;
        ...
        if(maxHeight > 55){
            ...
            list.find('li').css({height: maxHeight + 10});
            list.find('li span a').each(function(){
                var btn = $(this).closest('li');
                $(this).css({ top: btn.outerHeight() / 2 - $(this).outerHeight() / 2 });
            });
        }
    ...
    ,setupPrinting: function(data){
        ...
        print.append("<img src='../../global/licensing/renderingassets/windows8/images/print-logo.png'/>");

        var breadcrumb = me.getbreadcrumb(data);
        print.append("<div id='breadcrumb'>Source: <a href='http://www.microsoft.com/licensing/about-licensing/Windows8.aspx' target='_blank'>http://www.microsoft.com/licensing/about-licensing/Windows8.aspx</a><br /><span class='crumb'>" + breadcrumb + "</span></div>");
    ...
    ,genEmail: function(){
        var me = this;
        var body = "";
        body += encodeURIComponent("Window 8 Volume Licensing Buyer's Guide");
        body += "%0D%0A";
        body += encodeURIComponent("Return to Buyer's Guide: http://www.microsoft.com/licensing/about-licensing/Windows8.aspx");
        body += "%0D%0A";
        body += "%0D%0A";
        ...
        return "mailto:" + "?subject=" + encodeURIComponent("Answer from Window 8 Buyer's Guide") + "&body=" + body;
    }
    /**
