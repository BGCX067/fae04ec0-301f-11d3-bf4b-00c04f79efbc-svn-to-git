...
Renderer.prototype = {
    ...
    ,click: function(e){
        ...
        me.track(data, "Microsoft Volume Licensing - Dynamics AX 2012");
    }
    /**
    ...
    ,setupPrinting: function(data){
        ...
        print.append("<img src='../../global/licensing/renderingassets/dax2012/images/print-logo.png'/>");

        var breadcrumb = me.getbreadcrumb(data);
        print.append("<div id='breadcrumb'>Source: <a href='DynamicsAX-2.html'>http://www.microsoft.com/licensing/about-licensing/DynamicsAX.aspx</a><br /><span class='crumb'>" + breadcrumb + "</span></div>");
    ...
    ,genEmail: function(){
        var me = this;
        var body = "";
        body += encodeURIComponent("Microsoft Dynamics AX 2012 Volume Licensing Buyer's Guide");
        body += "%0D%0A";
        body += encodeURIComponent("Return to Buyer's Guide: http://www.microsoft.com/licensing/about-licensing/DynamicsAX.aspx");
        body += "%0D%0A";
        body += "%0D%0A";
        ...
        return "mailto:" + "?subject=" + encodeURIComponent("Answer from Microsoft Dynamics AX 2012 Buyer's Guide") + "&body=" + body;
    }
    /**
